...
public class RowImpl implements Row {
	...
	/* (non-Javadoc)
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#put(byte[], com.clouidio.orm.api.spi3.db.Column)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#columnSlice(byte[], byte[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.clouidio.orm.layer3.spi.db.inmemory.RowTemp#columnByPrefix(byte[])
	 */
	@Override
