...
public class ClasspathDiscoverer extends Discoverer {
	...
	private void processJar(URL fileInJarOrFolderUrl, List<URL> list) {
		...
		//format of jar file is file:/Users/5020659612/AAROOT/area1/fullSDI/restApi/lib/nosqlcassie.jar!/nosql/Persistence.class
		//so we split on ! first nd get the first piece.
		String[] pieces = file.split("!");
		String firstPiece = pieces[0];
		
		//Now we have firstPiece = file:/Users/5020659612/AAROOT/area1/fullSDI/restApi/lib/nosqlcassie.jar
