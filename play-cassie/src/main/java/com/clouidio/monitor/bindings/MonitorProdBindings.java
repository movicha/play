package com.clouidio.monitor.bindings;

import java.util.Map;
import java.util.concurrent.Executors;
import java.util.concurrent.ScheduledExecutorService;

import com.clouidio.monitor.api.MonitorServiceFactory;
import com.clouidio.monitor.impl.Config;
import com.clouidio.monitor.impl.HashGenerator;
import com.clouidio.monitor.impl.HashGeneratorImpl;
...
public class MonitorProdBindings implements Module {
	...
	public static final String SCHEDULER = "com.clouidio.monitor.scheduler";
	public static final String HASH_GENERATOR = "com.clouidio.monitor.hashGenerator";
