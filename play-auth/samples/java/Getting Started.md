...
Add `"com.clouidio"      %%  "play-authenticate" % "0.2.1-SNAPSHOT"` (`0.2.1` might actually change - have a look at the version history to select the latest version) as a dependency and add the resolvers as shown below:
	...
	object ApplicationBuild extends Build {
	    ...
	    val appDependencies = Seq(
	      ...
	      "com.clouidio"      %%  "play-authenticate" % "0.2.0-SNAPSHOT"
	    )
...
You also have to configure smtp and play-mailer. For testing purposes you can add the following line to your application.conf file:

	smtp.mock=true
	
For a real application you can use the following template ([source](https://github.com/clouidio/play-mailer/tree/master/samples/play-mailer-usage/conf)):
...
You have to add one import to include theses templates:
	...
	@import com.clouidio.play.module.auth.views.html._
...
Creating a logout link is straight forward:
	...
	<a href="@com.clouidio.play.module.auth.controllers.routes.Authenticate.logout">Logout</a>
...
TODO explain Resolver interface and its methods
	...
	import com.clouidio.play.module.auth.PlayAuthenticate.Resolver;
	import com.clouidio.play.module.auth.exceptions.AccessDeniedException;
		...
		public void onStart(final Application app) {
			PlayAuthenticate.setResolver(new Resolver() {
				...
				public Call auth(final String provider) {
					...
					return com.clouidio.play.module.auth.controllers.routes.Authenticate
...
of `com.clouidio.play.module.auth.service.UserServicePlugin` and implementing the abstract methods of this class.
...
Here is an example implementation of the UserServicePlugin:
	...
	import com.clouidio.play.module.auth.service.UserServicePlugin;
...
in `conf/play.plugins`. Add the following line:
	...
	10010:com.clouidio.play.module.auth.providers.oauth2.google.GoogleAuthProvider
