...
import com.clouidio.play.module.auth.controllers.Authenticate;
import com.clouidio.play.module.auth.exceptions.AuthException;
import com.clouidio.play.module.auth.providers.ext.ExternalAuthProvider;
import com.clouidio.play.module.auth.providers.openid.exceptions.NoOpenIdAuthException;
import com.clouidio.play.module.auth.providers.openid.exceptions.OpenIdConnectException;
...
public class OpenIdAuthProvider extends ExternalAuthProvider {
	...
	public Object authenticate(final Context context, final Object payload)
		...
		if (hasInfo) {
			// TODO: Switch to passing the UserInfo only
