...
import com.clouidio.play.module.auth.providers.AuthProvider;
import com.clouidio.play.module.auth.service.UserService;
...
public abstract class PlayAuthenticate {
	...
	public abstract static class Resolver {
		 ...
		 * com.clouidio.play.module.auth.controllers.AuthenticateController.
		 * authenticate(String)
	...
	private static final String ORIGINAL_URL = "auth.url.orig";
	private static final String USER_KEY = "auth.u.id";
	private static final String PROVIDER_KEY = "auth.p.id";
	private static final String EXPIRES_KEY = "auth.u.exp";
	private static final String SESSION_ID_KEY = "auth.s.id";
